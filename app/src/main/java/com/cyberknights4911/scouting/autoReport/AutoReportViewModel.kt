...
class AutoReportViewModel @Inject constructor(
    ...
    fun saveReport() {
        initialReport.value?.let { initialReport ->
            ...
            initialReport.collectedConesAuto = coneCount.value ?: 0
            initialReport.collectedCubesAuto = cubeCount.value ?: 0
            initialReport.droppedPiecesAuto = dropCount.value ?: 0

            initialReport.scoreHighAuto = highPieces.value ?: 0
            initialReport.scoreMidAuto = midPieces.value ?: 0
            initialReport.scoreLowAuto = lowPieces.value ?: 0
